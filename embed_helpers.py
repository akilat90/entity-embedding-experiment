...
def make_embedding_network():
    ...
    wc_embedding = Embedding(7, 3, input_length=1,
                             name='work_class_embedding')(wc_input)
    ...
    edu_embedding = Embedding(16, 4, input_length=1,
                              name='education_embedding')(edu_input)
    ...
    ms_embedding = Embedding(7, 3, input_length=1,
                             name='marital_status_embedding')(ms_input)
    ...
    oc_embedding = Embedding(14, 3, input_length=1,
                             name='occupation_embedding')(oc_input)
    ...
    rel_embedding = Embedding(6, 3, input_length=1,
                              name='relationship_embedding')(rel_input)
    ...
    race_embedding = Embedding(
        5, 2, input_length=1, name='race_embedding')(race_input)
    ...
    sex_embedding = Embedding(2, 1, input_length=1,
                              name='sex_embedding')(sex_input)
    ...
    country_embedding = Embedding(
        41, 10, input_length=1, name='country_embedding')(country_input)
...
def make_input_list(df, cat_names):
    ...
    cat_inputs = [df[cat_column].values.astype(
        int) for cat_column in cat_names]
    numeric_inputs = [
        df.loc[:, list(df.columns.difference(cat_names))].values.astype(np.float64)]
